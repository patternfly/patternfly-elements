...
- [](https://github.com/patternfly/patternfly-elements/commit/) feat: add textual button variant to pfe-autocomplete
...
- [](https://github.com/patternfly/patternfly-elements/commit/) fix: Update baseline snapshots to cover full page
