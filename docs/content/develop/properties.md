...
The property name `ariaHidden` results in an attribute named `aria-hidden`.  
...
With these property definitions, changes to `source` will be "forwarded" along to `destination`.
