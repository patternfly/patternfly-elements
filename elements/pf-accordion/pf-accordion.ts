...
export class PfAccordion extends BaseAccordion {
  ...
  static initRouter() {
    window.addEventListener('popstate', () =>
      PfAccordion.instances.forEach(el =>
   ...
   *
   * ```html
   * <pf-accordion history id="lorem-ipsum">
   *   <pf-accordion-header>
   *     <h3>Accordion 1</h3>
   *   </pf-accordion-header>
   *   <pf-accordion-panel>
  ...
  override connectedCallback(): void {
    ...
    PfAccordion.instances.add(this);
  ...
  disconnectedCallback() {
    ...
    PfAccordion.instances.delete(this);
  }
