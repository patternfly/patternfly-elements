...
const ICONS = {
  ...
  get(name: 'close' | 'custom' | 'success' | 'warning' | 'danger' | 'info') {
...
export class PfAlert extends LitElement {
  ...
  * */
  @property({ reflect: true }) timeout: string | undefined = undefined;

  @property({ reflect: true })
    variant: 'custom' | 'success' | 'warning' | 'danger' | 'info' = 'custom';
        ...
        <div id="middle-column">
          <header>
            ${!truncateTitle ? '' : html`
             ...
             `}
            <div id="header">
              ${title ? html`${title}` : html`<slot name="header"></slot>`}
