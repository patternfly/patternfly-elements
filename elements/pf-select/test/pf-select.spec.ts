...
describe('<pf-select>', function() {
  ...
  describe('variant="single" always-expanded', function() {
  ...
  describe('variant attribute', function() {
    ...
    describe('"checkbox" with two items selected', function() {
      beforeEach(async function() {
        element = await createFixture<PfSelect>(html`
    ...
    describe('"typeaheadmulti" with two options selected', function() {
      beforeEach(async function() {
        element = await createFixture<PfSelect>(html`
      ...
      it('combo text should be "2 items selected"', async function() {
        const snapshot = await a11ySnapshot();
