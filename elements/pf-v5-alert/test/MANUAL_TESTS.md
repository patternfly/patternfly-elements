# pf-v5-alert — Manual Tests

This document outlines manual testing procedures for the `pf-v5-alert` component, based on its functionality, attributes, and slots.
...
npm run start
```
2. Open the demo page where the pf-v5-alert component is displayed in your browser.
...
- [ ] The pf-v5-icon element is present in the #icon-container.
...
- [ ] Render the alert with timeout="1000" (1 second). Wait 1.5 seconds.
    ...
    [ ] Verify that the custom event pf-v5-alert:timeout was dispatched before removal.
...
### General
- [ ] Verify the component's root element correctly reflects the ouia-id attribute when set (e.g., <pf-v5-alert ouia-id="test-1">).
