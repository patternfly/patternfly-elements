...
`<pf-v5-code-block>` is a component that contains two or more lines of ready-only 
...
Load `<pf-v5-code-block>` via CDN:

```html
<script src="https://jspm.dev/@patternfly/elements/pf-v5-code-block/pf-v5-code-block.js"></script>
```
