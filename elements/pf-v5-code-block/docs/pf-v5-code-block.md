...
{% renderOverview %}
  ...
  <pf-v5-code-block id="code">
    ...
    <pf-v5-clipboard slot="actions" copy-from="#code"></pf-v5-clipboard>
  </pf-v5-code-block>
{% endrenderOverview %}
...
To add copy-to-clipboard functionality, be sure to import `@patternfly/pf-v5-clipboard` and add the `pf-v5-clipboard` to the `action` slot.

{% htmlexample %}
<pf-v5-code-block id="basic">
  <script type="application/openshift">
    apiVersion: helm.openshift.io/v1beta1/
    kind: HelmChartRepository
    metadata:
  ...
  <pf-v5-clipboard slot="actions" copy-from="#basic"></pf-v5-clipboard>
</pf-v5-code-block>
{% endhtmlexample %}
...
<pf-v5-code-block id="expandable-code">
  ...
  <pf-v5-clipboard slot="actions" copy-from="#expandable-code"></pf-v5-clipboard>
</pf-v5-code-block>
{% endhtmlexample %}
{% endband %}
