...
{% renderOverview %}
  <pf-v5-dropdown>
    <pf-v5-dropdown-item>Action</pf-v5-dropdown-item>
    <pf-v5-dropdown-item href="#">Link</pf-v5-dropdown-item>
    <pf-v5-dropdown-item disabled>Disabled Action</pf-v5-dropdown-item>
    <pf-v5-dropdown-item disabled href="#">Link</pf-v5-dropdown-item>
    <hr>
    <pf-v5-dropdown-item>Separated Action</pf-v5-dropdown-item>
    <hr>
    <pf-v5-dropdown-item href="#">Separated Link</pf-v5-dropdown-item>
  </pf-v5-dropdown>
{% endrenderOverview %}
...
{% htmlexample %}
  <pf-v5-dropdown>
    <pf-v6-button slot="toggle" variant="control">
      My Custom Dropdown 
...
{% htmlexample %}
<pf-v5-dropdown>
  <pf-v6-button slot="toggle" accessible-label="Toggle" variant="plain">
...
<pf-v5-dropdown>
  ...
  <pf-v5-dropdown-group label="Group 2">
    <pf-v5-dropdown-item>Group 2 action</pf-v5-dropdown-item>
    <pf-v5-dropdown-item href="#">Group 2 link</pf-v5-dropdown-item>
  </pf-v5-dropdown-group>
  <hr>
  <pf-v5-dropdown-group label="Group 3">
    <pf-v5-dropdown-item>Group 3 action</pf-v5-dropdown-item>
    <pf-v5-dropdown-item href="#">Group 3 link</pf-v5-dropdown-item>
  </pf-v5-dropdown-group>
</pf-v5-dropdown>
{% endhtmlexample %}
...
<pf-v5-dropdown>
  ...
  <pf-v5-dropdown-item disabled href="#">
    Disabled link
...
<pf-v5-dropdown>
  <pf-v5-dropdown-item>
    <pf-v5-icon icon="user" aria-label="user" size="md" slot="icon"></pf-v5-icon>
    User
  </pf-v5-dropdown-item>
  <pf-v5-dropdown-item>
    <pf-v5-icon icon="lock" aria-label="user" size="md" slot="icon"></pf-v5-icon>
    Lock
  </pf-v5-dropdown-item>
</pf-v5-dropdown>
{% endhtmlexample %}
