...
Load `<pf-v5-label>` via CDN:

```html
<script src="https://jspm.dev/@patternfly/elements/pf-v5-label/pf-v5-label.js"></script>
```
...
Default
```html
<p>Some Text <pf-v5-label>Your label text here</pf-v5-label></p>
```

Color Options: `grey (default), blue ,green, orange, red, purple, cyan`
```html
<p>Some Text <pf-v5-label color="red">Your label text here</pf-v5-label></p>
```

With and Icon:
```html
<p>Some Text <pf-v5-label icon="web-icon-globe">Your label text here</pf-v5-label></p>
```

Outline variant:
```html
<p>Some Text <pf-v5-label outline>Your label text here</pf-v5-label></p>
```
