...
{% renderOverview %}
  <pf-v5-label>Default</pf-v5-label>
{% endrenderOverview %}
...
{% band header="Usage" %}
  ...
  <pf-v5-label color="red">Red</pf-v5-label>
  <pf-v5-label color="purple">Purple</pf-v5-label>
  <pf-v5-label color="cyan">Cyan</pf-v5-label>
  <pf-v5-label color="gold">Gold</pf-v5-label>
  {% endhtmlexample %}
  ...
  {% htmlexample %}
  <pf-v5-label variant="outline" color="blue">Blue</pf-v5-label>
  <pf-v5-label variant="outline" color="green">Green</pf-v5-label>
  <pf-v5-label variant="outline" color="orange">Orange</pf-v5-label>
  <pf-v5-label variant="outline" color="red">Red</pf-v5-label>
  <pf-v5-label variant="outline" color="purple">Purple</pf-v5-label>
  <pf-v5-label variant="outline" color="cyan">Cyan</pf-v5-label>
  <pf-v5-label variant="outline" color="gold">Gold</pf-v5-label>
  <pf-v5-label variant="outline">Default</pf-v5-label>
  {% endhtmlexample %}
  ...
  {% htmlexample %}
  <pf-v5-label color="blue" icon="globe">Globe</pf-v5-label>
  {% endhtmlexample %}
  ...
  {% htmlexample %}
  <pf-v5-label color="blue">Globe
    <pf-v5-icon slot="icon" icon="globe" size="sm"></pf-v5-icon>
  </pf-v5-label>
  {% endhtmlexample %}
  ...
  {% htmlexample %}
  <pf-v5-label compact color="blue">Globe
    <svg slot="icon"
         xmlns="http://www.w3.org/2000/svg"
         viewBox="0 0 17 17"
         fill="currentColor"
  ...
  <pf-v5-label compact color="green">Green</pf-v5-label>
  <pf-v5-label compact variant="outline" color="orange">Orange</pf-v5-label>
  <pf-v5-label compact color="red" icon="globe">Red</pf-v5-label>
  <pf-v5-label compact variant="outline" color="purple">Purple</pf-v5-label>
  <pf-v5-label compact color="cyan">Cyan</pf-v5-label>
  <pf-v5-label compact variant="outline" color="gold">Gold <pf-v5-icon slot="icon" icon="globe" size="sm"></pf-v5-icon></pf-v5-label>
  <pf-v5-label compact>Default</pf-v5-label>
  {% endhtmlexample %}
{% endband %}
