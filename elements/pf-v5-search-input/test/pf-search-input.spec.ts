...
describe('<pf-v5-search-input>', function() {
  describe('simply instantiating', function() {
    ...
    it('should upgrade', async function() {
      element = await createFixture<PfV5SearchInput>(html`<pf-v5-search-input></pf-v5-search-input>`);
  ...
  describe('with accessible-label attribute and 3 items', function() {
    ...
    beforeEach(async function() {
      element = await createFixture<PfV5SearchInput>(html`
        <pf-v5-search-input accessible-label="label">
  ...
  describe('with `disabled` attribute', function() {
    ...
    beforeEach(async function() {
      element = await createFixture<PfV5SearchInput>(html`
        <pf-v5-search-input id="disabled-search" disabled>
          <pf-v5-option value="1">1</pf-v5-option>
          <pf-v5-option value="2">2</pf-v5-option>
          <pf-v5-option value="3">3</pf-v5-option>
        </pf-v5-search-input>
  ...
  describe('Outside click behavior', function() {
    ...
    beforeEach(async function() {
      element = await createFixture<PfV5SearchInput>(html`
        <pf-v5-search-input>
          <pf-v5-option value="11">11</pf-v5-option>
          <pf-v5-option value="12">12</pf-v5-option>
          <pf-v5-option value="13">13</pf-v5-option>
          <pf-v5-option value="21">21</pf-v5-option>
          <pf-v5-option value="22">22</pf-v5-option>
          <pf-v5-option value="23">23</pf-v5-option>
        </pf-v5-search-input>
      `);
  ...
  describe('form submission with pf-v5-search-input', function() {
    ...
    beforeEach(async function() {
      form = await createFixture<HTMLFormElement>(html`
        <form>
          <pf-v5-search-input name="search">
            <pf-v5-option value="Alabama">Alabama</pf-v5-option>
            <pf-v5-option value="New York">New York</pf-v5-option>
            <pf-v5-option value="New Jersey">New Jersey</pf-v5-option>
          </pf-v5-search-input>
