...
import { PfeAccordion } from '@patternfly/elements/pfe-accordion/pfe-accordion.js';
import { PfeAccordionPanel } from '@patternfly/elements/pfe-accordion/pfe-accordion-panel.js';
import { PfeAccordionHeader } from '@patternfly/elements/pfe-accordion/pfe-accordion-header.js';
...
describe('<pfe-accordion>', function() {
  ...
  let headers: PfeAccordionHeader[];
  let panels: PfeAccordionPanel[];
  let header: PfeAccordionHeader;
  let panel: PfeAccordionPanel;
  let secondHeader: PfeAccordionHeader;
  let secondPanel: PfeAccordionPanel;
  ...
  it('simply instantiating', async function() {
    element = await createFixture<PfeAccordion>(html`<pfe-accordion></pfe-accordion>`);
  ...
  describe('in typical usage', function() {
    beforeEach(async function() {
      element = await createFixture<PfeAccordion>(html`
        <pfe-accordion>
          <pfe-accordion-header id="header1" data-index="0">
            <h3>Consetetur sadipscing elitr?</h3>
          </pfe-accordion-header>
          <pfe-accordion-panel id="panel1" data-index="0">
          ...
          <pfe-accordion-header data-index="1">
            <h3>Labore et dolore magna aliquyam erat?</h3>
          </pfe-accordion-header>
          <pfe-accordion-panel data-index="1">
            <p><a href="#">Lorem ipsum dolor sit amet</a>, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt
              ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea
              rebum.</p>
          </pfe-accordion-panel>
          <pfe-accordion-header data-index="2">
            <h3>Incididunt in Lorem voluptate eiusmod dolor?</h3>
          </pfe-accordion-header>
          <pfe-accordion-panel data-index="2">
            <p><a href="#">Lorem ipsum dolor sit amet</a>, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt
              ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea
              rebum.</p>
          </pfe-accordion-panel>
  ...
  describe('with nested pfe-accordion', function() {
    let topLevelHeaderOne: PfeAccordionHeader;
    let topLevelHeaderTwo: PfeAccordionHeader;

    let topLevelPanelOne: PfeAccordionPanel;
    let topLevelPanelTwo: PfeAccordionPanel;

    let nestedHeaderOne: PfeAccordionHeader;
    let nestedHeaderTwo: PfeAccordionHeader;

    let nestedPanelOne: PfeAccordionPanel;
    let nestedPanelTwo: PfeAccordionPanel;

    beforeEach(async function() {
      element = await createFixture<PfeAccordion>(html`
        <pfe-accordion>
          <pfe-accordion-header id="header-1" data-index="0"></pfe-accordion-header>
          <pfe-accordion-panel id="panel-1" data-index="0">
            <pfe-accordion>
              <pfe-accordion-header id="header-1-1" data-index="0-1"></pfe-accordion-header>
              <pfe-accordion-panel id="panel-1-1" data-index="0-1"></pfe-accordion-panel>
            </pfe-accordion>
          </pfe-accordion-panel>
          <pfe-accordion-header id="header-2" data-index="2"></pfe-accordion-header>
          <pfe-accordion-panel id="panel-2" data-panel="2">
            <pfe-accordion single>
              <pfe-accordion-header id="header-2-1" data-index="1-0"></pfe-accordion-header>
              <pfe-accordion-panel id="panel-2-1" data-index="1-0"></pfe-accordion-panel>
              <pfe-accordion-header id="header-2-2" data-index="1-1"></pfe-accordion-header>
              <pfe-accordion-panel id="panel-2-2" data-index="1-1"></pfe-accordion-panel>
            </pfe-accordion>
          </pfe-accordion-panel>
        
          <pfe-accordion-header id="header-3" data-index="2"></pfe-accordion-header>
          <pfe-accordion-panel id="panel-3" data-index="2"></pfe-accordion-panel>
        </pfe-accordion>
      `);
      topLevelHeaderOne = document.getElementById('header-1') as PfeAccordionHeader;
      topLevelHeaderTwo = document.getElementById('header-2') as PfeAccordionHeader;

      topLevelPanelOne = document.getElementById('panel-1') as PfeAccordionPanel;
      topLevelPanelTwo = document.getElementById('panel-2') as PfeAccordionPanel;

      nestedHeaderOne = document.getElementById('header-2-1') as PfeAccordionHeader;
      nestedHeaderTwo = document.getElementById('header-2-2') as PfeAccordionHeader;

      nestedPanelOne = document.getElementById('panel-2-1') as PfeAccordionPanel;
      nestedPanelTwo = document.getElementById('panel-2-2') as PfeAccordionPanel;
