...
suite("<pfe-icon>", () => {
  ...
  test("it should upgrade", () => {
    assert.instanceOf(
      document.querySelector("pfe-icon"),
      customElements.get("pfe-icon", "pfe-icon should be an instance of pfeIcon")
    );
  });
  ...
  test("it should change size based on the relative size attribute values", async () => {
    // a function that accepts "size" values and makes sure they're
    // arranged in order from smallest to largest.
    async function sizeCheck(sizes) {
