...
import PfeNavigationDropdown from "../dist/pfe-navigation-dropdown";

const stories = storiesOf("Navigation dropdown", module);

// Define the template to be used
const template = (data = {}) => {
  return tools.component(PfeNavigationDropdown.tag, data.prop, data.slots);
};
...
stories.add(PfeNavigationDropdown.tag, () => {
  let config = {};
  const props = PfeNavigationDropdown.properties;
  ...
  const slots = PfeNavigationDropdown.slots;
