...
suite('<pfe-navigation>', () => {
  ...
  // test(`it should add sticky="true" on upgrade`, () => {
  //   assert.equal(pfeNavigation.getAttribute('sticky'), 'true');
  // });

  // pfe-close-on-click="external"
  // NOTE: pfe-close-on-click is not added as an attribute on upgrade
  // test(`it should add close-on-click="external" on upgrade`, () => {
  //   assert.equal(pfeNavigation.getAttribute('close-on-click'), 'external');
  // });
