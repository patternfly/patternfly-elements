 ...
 *
 * @csspart circle - container for the step circle graphic
 * @csspart content - container for the step content (title and description)
 * @csspart title - container for the step title
 * @csspart description - container for the step description
 *
...
export class PfeProgressStepsItem extends LitElement {
  ...
  render() {
    return html`
      <div class="pfe-progress-steps-item__circle" part="circle">${this.icon}</div>${this.slots.hasSlotted('title', 'description') ? html`
        <div class="pfe-progress-steps-item__content" part="content">${this.slots.hasSlotted('title') ? html`
          <div class="pfe-progress-steps-item__content--title" part="title">
            <slot name="title"></slot>
          </div>` : ''}${this.slots.hasSlotted('description') ? html`
          <div class="pfe-progress-steps-item__content--description" part="description">
