 ...
 *
 * @csspart progress-bar - container for the progress-bar element
 *
...
export class PfeProgressSteps extends LitElement {
  ...
  render() {
    return html`
      <div class="pfe-progress-steps__progress-bar" part="progress-bar">
  ...
  @bound private _build() {
    ...
    for (let index = 0; index < items.length; index++) {
      ...
      if (!this.vertical) {
        ...
        // that was set.
        item.style.minHeight = (index === items.length - 1) ? '0' : '';
      }
    }
  }
}
