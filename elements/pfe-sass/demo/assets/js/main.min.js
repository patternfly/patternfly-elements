      ...
      var e,
        ...
        m = function(t, e, n) {
          void 0 !== t &&
            ...
            s.isMatch &&
              ((r = d[n]),
              r ? (r.score = Math.min(r.score, s.score)) : ((d[n] = { item: e, score: s.score }), f.push(d[n]))));
        };
      if ("string" == typeof h[0]) for (var e = 0; p > e; e++) m(h[e], e, e);
      else for (var e = 0; p > e; e++) for (o = h[e], n = 0; u > n; n++) m(this.options.getFn(o, l[n]), o, e);
...
(function($, global) {
  ...
  Sidebar.prototype.loadToggle = function() {
    $("<span />", { class: "layout-toggle", html: "&times;", "data-alt": "&#8594;" }).appendTo($(".header"));
  ...
  Search.prototype.initialize = function() {
    this.index = new Fuse(
      $.map($(this.conf.search.items), function(item) {
        var $item = $(item);
        return { group: $item.data("group"), name: $item.data("name"), type: $item.data("type"), node: $item };
      }),
      this.conf.fuse
    );
...
(function($, global) {
  ...
  var App = function(conf) {
    this.conf = $.extend({ search: new global.Search(), sidebar: new global.Sidebar(), init: true }, conf || {});
