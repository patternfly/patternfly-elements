(window.webpackJsonp = window.webpackJsonp || []).push([
  [2],
  {
          ...
          (a = function(e) {
            !(function(e, n) {
              ...
              if (
                ...
                for (g.set = d, a = document.getElementsByTagName("iframe"), t = a.length; t--; ) g.set(a[t]);
            })(e, r),
              (i.srcDoc = e);
    ...
    J4ja: function(e, n) {
      e.exports = {
        colors: {
          "brand-colors": { "brand-orange": "#c75000", "brand-blue": "#0d7fa5", "brand-pink": "#aa0e5c" },
          "neutral-colors": {
            "light-gray": "#dedede",
            gray: "#555b5e",
            "contrast-light": "#fff",
          ...
          "demo-noncolors": { "light-gray": "#dedede", gray: "#555b5e", "contrast-dark": "#3b4042" }
        },
        ...
        sizes: {
          ...
          "layout-sizes": { page: "50rem", "item-break": "40em", "page-break": "50em", "nav-break": "65em" },
          "demo-sizes": { root: "18px", responsive: "calc(1.5em + 1vw)", xlarge: "3rem" },
        ...
        fonts: {
          ...
          "demo-local": {
            name: "rockingham",
            normal: { path: "rockingham/rockingham-regular-webfont", local: "rockingham-regular-webfont" },
      ...
      !(function(e) {
        ...
        (function(e) {
                ...
                for (var i = t.firstChild; i; i = i.nextSibling)
                  3 === i.nodeType
                    ...
                    : 1 === i.nodeType &&
                      ...
                      (a = e(i, a)),
                      d(i).match(/br|hr|img|input/) || n.push({ event: "stop", offset: a, node: i }));
                return a;
              })(e, 0),
              n
            );
          ...
          function f(e) {
            ...
            function a(t, a) {
              return new RegExp(n(t), "m" + (e.case_insensitive ? "i" : "") + (a ? "g" : ""));
            }
            !(function i(r, s) {
              if (!r.compiled) {
                if (((r.compiled = !0), (r.keywords = r.keywords || r.beginKeywords), r.keywords)) {
                  ...
                  "string" == typeof r.keywords
                    ...
                    : t(r.keywords).forEach(function(e) {
                        l(e, r.keywords[e]);
                      }),
                    (r.keywords = o);
                }
                (r.lexemesRe = a(r.lexemes || /\w+/, !0)),
                  s &&
                    (r.beginKeywords && (r.begin = "\\b(" + r.beginKeywords.split(" ").join("|") + ")\\b"),
                    r.begin || (r.begin = /\B|\b/),
                    (r.beginRe = a(r.begin)),
                    ...
                    r.endsWithParent &&
                      s.terminator_end &&
                      (r.terminator_end += (r.end ? "|" : "") + s.terminator_end)),
          ...
          function p(e, n, t, i) {
            ...
            function o(e, n, t, a) {
              var i = '<span class="' + (a ? "" : l.classPrefix);
              return (i += e + '">') + n + (t ? "" : "</span>");
            }
            function d() {
              (N +=
                null != w.subLanguage
                  ? (function() {
                      ...
                      if (e && !a[w.subLanguage]) return c(y);
                      var n = e
                        ? p(w.subLanguage, y, !0, _[w.subLanguage])
                        : h(y, w.subLanguage.length ? w.subLanguage : void 0);
                      return (
                        w.relevance > 0 && (x += n.relevance),
                  ...
                  : (function() {
                      var e, n, t, a;
                      if (!w.keywords) return c(y);
                      for (a = "", n = 0, w.lexemesRe.lastIndex = 0, t = w.lexemesRe.exec(y); t; )
                        (a += c(y.substring(n, t.index))),
                          (e = s(w, t)) ? ((x += e[1]), (a += o(e[0], c(t[0])))) : (a += c(t[0])),
                          (n = w.lexemesRe.lastIndex),
                          (t = w.lexemesRe.exec(y));
                      return a + c(y.substr(n));
                    })()),
                (y = "");
            }
            function u(e) {
              (N += e.className ? o(e.className, "", !0) : ""), (w = Object.create(e, { parent: { value: w } }));
            }
            function m(e, n) {
              if (((y += e), null == n)) return d(), 0;
              var a = (function(e, n) {
                var t, a;
                for (t = 0, a = n.contains.length; t < a; t++)
                  if (g(n.contains[t].beginRe, e))
                    return (
                      n.contains[t].endSameAsBegin && (n.contains[t].endRe = r(n.contains[t].beginRe.exec(e)[0])),
                      n.contains[t]
                    );
              })(n, w);
              if (a)
                return (
                  a.skip ? (y += n) : (a.excludeBegin && (y += n), d(), a.returnBegin || a.excludeBegin || (y = n)),
                  u(a),
              ...
              if (i) {
                var s = w;
                s.skip ? (y += n) : (s.returnEnd || s.excludeEnd || (y += n), d(), s.excludeEnd && (y = n));
                do {
                  w.className && (N += "</span>"), w.skip || w.subLanguage || (x += w.relevance), (w = w.parent);
                } while (w !== i.parent);
                return (
                  i.starts && (i.endSameAsBegin && (i.starts.endRe = i.endRe), u(i.starts)), s.returnEnd ? 0 : n.length
                );
              }
              if (
                (function(e, n) {
                  return !t && g(n.illegalRe, e);
                })(n, w)
              )
                throw new Error('Illegal lexeme "' + n + '" for mode "' + (w.className || "<unnamed>") + '"');
              return (y += n), n.length || 1;
            }
            var b = v(e);
            ...
            var E,
              ...
              _ = {},
              N = "";
            for (E = w; E !== b; E = E.parent) E.className && (N = o(E.className, "", !0) + N);
            var y = "",
              x = 0;
            try {
              for (var M, O, S = 0; (w.terminators.lastIndex = S), (M = w.terminators.exec(n)); )
                (O = m(n.substring(S, M.index), M[0])), (S = M.index + O);
              for (m(n.substr(S)), E = w; E.parent; E = E.parent) E.className && (N += "</span>");
              return { relevance: x, value: N, language: e, top: w };
            } catch (e) {
              if (e.message && -1 !== e.message.indexOf("Illegal")) return { relevance: 0, value: c(n) };
              throw e;
            }
          }
          function h(e, n) {
            n = n || l.languages || t(a);
            var i = { relevance: 0, value: c(e) },
              r = i;
            return (
              n
                .filter(v)
            ...
            var t,
              ...
              m = (function(e) {
                var n,
                  ...
                  i,
                  r = e.className + " ";
                if (((r += e.parentNode ? e.parentNode.className : ""), (t = s.exec(r))))
                  return v(t[1]) ? t[1] : "no-highlight";
                for (n = 0, a = (r = r.split(/\s+/)).length; n < a; n++) if (u((i = r[n])) || v(i)) return i;
              })(e);
            u(m) ||
              (l.useBR
              ...
              (a = b(t)).length &&
                ...
                (r.value = (function(e, t, a) {
                  ...
                  function u(e) {
                    ("start" === e.event ? l : g)(e.node);
                  }
                  for (; e.length || t.length; ) {
                    var m = o();
                    if (((r += c(a.substring(i, m[0].offset))), (i = m[0].offset), m === e)) {
                      s.reverse().forEach(g);
                      do {
                        u(m.splice(0, 1)[0]), (m = o());
                      } while (m === e && m.length && m[0].offset === i);
                      s.reverse().forEach(l);
                    } else "start" === m[0].event ? s.push(m[0].node) : s.pop(), u(m.splice(0, 1)[0]);
                  }
                  return r + c(a.substr(i));
                })(a, b(o), g))),
              (r.value = E(r.value)),
              (e.innerHTML = r.value),
          ...
          (e.highlight = p),
            ...
            (e.COMMENT = function(n, t, a) {
              var i = e.inherit({ className: "comment", begin: n, end: t, contains: [] }, a || {});
              return (
                i.contains.push(e.PHRASAL_WORDS_MODE),
                i.contains.push({ className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0 }),
                i
              );
            }),
            ...
            e.registerLanguage("json", function(e) {
              var n = { literal: "true false null" },
                ...
                a = { end: ",", endsWithParent: !0, excludeEnd: !0, contains: t, keywords: n },
                i = {
                  begin: "{",
                  end: "}",
                  contains: [
                ...
                r = { begin: "\\[", end: "\\]", contains: [e.inherit(a)], illegal: "\\S" };
              return t.splice(t.length, 0, i, r), { contains: t, keywords: n, illegal: "\\S" };
            }),
            ...
            e.registerLanguage("ruby", function(e) {
              var n = "[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",
                ...
                l = { className: "params", begin: "\\(", end: "\\)", endsParent: !0, keywords: t },
                c = [
                  o,
                  i,
                  {
                  ...
                  },
                  {
                    ...
                    contains: [e.inherit(e.TITLE_MODE, { begin: n }), l].concat(r)
                  },
                  { begin: e.IDENT_RE + "::" },
    ...
    t3mS: function(e, n, t) {
      ...
      (function(e) {
        ...
        var a = t("J4ja"),
          ...
          r = function() {
            ...
            n.on("toggle:close", '[data-toggle="button"]', function() {
              var n = e(this).attr("aria-controls"),
                t = e('[data-target-id="'.concat(n, '"]'));
              e('[data-toggle="button"][aria-controls="'.concat(n, '"][aria-pressed="true"]')).attr(
                "aria-pressed",
                "false"
              ),
              ...
              n.on("toggle:open", '[data-toggle="button"]', function() {
                var n = e(this),
                  ...
                  a = e('[data-target-id="'.concat(t, '"]')),
                  i = e('[data-toggle="button"][aria-controls="'.concat(t, '"]')).not(n);
                n.data("toggle-synced")
                  ? i.filter('[data-toggle-synced="true"]').attr("aria-pressed", "true")
                  : i.filter('[aria-pressed="true"]').attr("aria-pressed", "false"),
            ...
            var t = function(n) {
              var t = n.attr("data-target-id"),
                a = e('[data-toggle="button"][aria-controls="'.concat(t, '"][aria-pressed="true"]'));
            ...
            n.on("target:open", '[data-toggle="target"]', function(n) {
              ...
              n.on("click", '[data-toggle="button"]', function(n) {
                n.preventDefault();
                var t = e(this);
                "true" === t.attr("aria-pressed") ? t.trigger("toggle:close") : t.trigger("toggle:open");
              }),
              n.on("click", '[data-toggle="close"]', function(n) {
                n.preventDefault();
                var a = e('[data-target-id="'.concat(e(this).attr("aria-controls"), '"]'));
                t(a);
              });
            n.on("click", function(n) {
              e('[data-toggle="target"][aria-expanded="true"][data-auto-closing="true"]').each(function(a, i) {
                !(function(e, n) {
                  var a = n.attr("data-target-id"),
                    i = e.closest('[aria-controls="'.concat(a, '"]')).length,
                    r = document.contains(e.get(0)),
                    s = !e.closest(n).length,
                    o = n.attr("data-auto-closing-exception"),
                    l = !!o && e.closest(o).length;
                  !i && (n.data("auto-closing-on-any-click") || (r && s && !l)) && t(n);
                })(e(n.target), e(i));
              });
            });
          },
          s = function() {
            var n = function(n) {
                n.contentWindow.document.body && (n.height = e(n.contentWindow.document).outerHeight(!0));
              },
              t = function() {
          ...
          o = function() {
            var n = i.a && i.a.sizes && i.a.sizes["layout-sizes"] && i.a.sizes["layout-sizes"]["nav-break"];
            if (n) {
              var t = e("#nav"),
                a = e('[aria-controls="nav"]'),
                r = window.matchMedia("(min-width: ".concat(n, ")")),
                s = function(e) {
                  e.matches ? t.attr("aria-expanded", "true") : t.attr("aria-expanded", a.attr("aria-pressed"));
                };
              s(r), r.addListener(s);
            }
          };
