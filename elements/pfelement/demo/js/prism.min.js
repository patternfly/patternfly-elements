  ...
  Prism = (function() {
    var l = /\blang(?:uage)?-([\w-]+)\b/i,
      ...
      T = (_self.Prism = {
        ...
        util: {
          encode: function(e) {
            return e instanceof s
              ? new s(e.type, T.util.encode(e.content), e.alias)
              : "Array" === T.util.type(e)
              ? e.map(T.util.encode)
              : e
                  .replace(/&/g, "&amp;")
          ...
          clone: function(e, n) {
            ...
            switch (((n = n || {}), t)) {
              case "Object":
                ...
                var a = {};
                for (var r in ((n[T.util.objId(e)] = a), e)) e.hasOwnProperty(r) && (a[r] = T.util.clone(e[r], n));
                return a;
              case "Array":
                if (n[T.util.objId(e)]) return n[T.util.objId(e)];
                a = [];
        ...
        languages: {
          ...
          insertBefore: function(n, e, t, a) {
            ...
            for (var o in r)
              if (r.hasOwnProperty(o)) {
                if (o == e) for (var i in t) t.hasOwnProperty(i) && (s[i] = t[i]);
                s[o] = r[o];
              }
            return (
          ...
          DFS: function(e, t, n, a) {
            for (var r in ((a = a || {}), e))
              e.hasOwnProperty(r) &&
                (t.call(e, r, e[r], n || r),
                "Object" !== T.util.type(e[r]) || a[T.util.objId(e[r])]
                  ? "Array" !== T.util.type(e[r]) ||
                    a[T.util.objId(e[r])] ||
                    ((a[T.util.objId(e[r])] = !0), T.languages.DFS(e[r], t, r, a))
                  : ((a[T.util.objId(e[r])] = !0), T.languages.DFS(e[r], t, null, a)));
          }
        },
        plugins: {},
        ...
        highlightElement: function(e, t, n) {
          for (var a, r, i = e; i && !l.test(i.className); ) i = i.parentNode;
          i && ((a = (i.className.match(l) || [, ""])[1].toLowerCase()), (r = T.languages[a])),
            (e.className = e.className.replace(l, "").replace(/\s+/g, " ") + " language-" + a),
            e.parentNode &&
              ((i = e.parentNode),
              /pre/i.test(i.nodeName) &&
                (i.className = i.className.replace(l, "").replace(/\s+/g, " ") + " language-" + a));
          var s = { element: e, language: a, grammar: r, code: e.textContent };
          if ((T.hooks.run("before-sanity-check", s), !s.code || !s.grammar))
            return (
              s.code &&
                (T.hooks.run("before-highlight", s),
                (s.element.textContent = s.code),
                T.hooks.run("after-highlight", s)),
              void T.hooks.run("complete", s)
            );
          if ((T.hooks.run("before-highlight", s), t && _self.Worker)) {
        ...
        highlight: function(e, t, n) {
          ...
          return (
            ...
            s.stringify(T.util.encode(a.tokens), a.language)
          );
        },
          ...
          for (var l in n)
            if (n.hasOwnProperty(l) && n[l]) {
              ...
              for (var c = 0; c < u.length; ++c) {
                ...
                d = d.pattern || d;
                for (var y = a, v = r; y < t.length; v += t[y].length, ++y) {
                  var k = t[y];
                  if (t.length > e.length) return;
                  if (!(k instanceof o)) {
                    if (p && y != t.length - 1) {
                      if (((d.lastIndex = v), !(F = d.exec(e)))) break;
                      for (
                        var w = F.index + (m ? F[1].length : 0), P = F.index + F[0].length, x = y, A = v, C = t.length;
                        x < C && (A < P || (!t[x].type && !t[x - 1].greedy));
                        ++x
                      )
                        (A += t[x].length) <= w && (++y, (v = A));
                      if (t[y] instanceof o) continue;
                      (S = x - y), (k = e.slice(v, A)), (F.index -= v);
                    } else {
                      d.lastIndex = 0;
                      var F = d.exec(k),
                        S = 1;
                    ...
                    if (F) {
                      m && (f = F[1] ? F[1].length : 0);
                      P = (w = F.index + f) + (F = F[0].slice(f)).length;
                      var N = k.slice(0, w),
                        j = k.slice(P),
                        E = [y, S];
                      N && (++y, (v += N.length), E.push(N));
                      var _ = new o(l, g ? T.tokenize(F, g) : F, h, F, p);
                      if (
                        (E.push(_),
                        j && E.push(j),
                        Array.prototype.splice.apply(t, E),
                        1 != S && T.matchGrammar(e, t, n, y, v, !0, l),
                        i)
                      )
                        break;
                    } else if (i) break;
    ...
    if (
      ((s.stringify = function(t, n, e) {
        ...
        if (t.alias) {
          var r = "Array" === T.util.type(t.alias) ? t.alias : [t.alias];
          Array.prototype.push.apply(a.classes, r);
        }
        T.hooks.run("wrap", a);
        var i = Object.keys(a.attributes)
          .map(function(e) {
  ...
  "undefined" != typeof self &&
    ...
    ((self.Prism.fileHighlight = function() {
      ...
      Array.prototype.slice.call(document.querySelectorAll("pre[data-src]")).forEach(function(t) {
        for (
          var e, n = t.getAttribute("data-src"), a = t, r = /\blang(?:uage)?-(?!\*)([\w-]+)\b/i;
          a && !r.test(a.className);

        )
          a = a.parentNode;
        if ((a && (e = (t.className.match(r) || [, ""])[1]), !e)) {
          var i = (n.match(/\.(\w+)$/) || [, ""])[1];
          e = l[i] || i;
        }
        ...
        o.open("GET", n, !0),
          (o.onreadystatechange = function() {
            4 == o.readyState &&
              (o.status < 400 && o.responseText
                ...
                : 400 <= o.status
                ? (s.textContent = "✖ Error " + o.status + " while fetching file: " + o.statusText)
          ...
          t.hasAttribute("data-download-link") &&
            ...
            Prism.plugins.toolbar.registerButton("download-file", function() {
              ...
              return (
                (e.textContent = t.getAttribute("data-download-link-label") || "Download"),
  ...
  (function() {
    ...
    (e.prototype = {
      ...
      normalize: function(e, t) {
        for (var n in (t = r(this.defaults, t))) {
          var a = n.replace(/-(\w)/g, function(e, t) {
            return t.toUpperCase();
          });
          "normalize" !== n && "setDefaults" !== a && t[n] && this[a] && (e = this[a].call(this, e, t[n]));
        }
        return e;
      },
      leftTrim: function(e) {
      ...
      breakLines: function(e, t) {
        ...
        for (var n = e.split("\n"), a = 0; a < n.length; ++a)
          if (!(l(n[a]) <= t)) {
            for (var r = n[a].split(/(\s+)/g), i = 0, s = 0; s < r.length; ++s) {
              var o = l(r[s]);
              t < (i += o) && ((r[s] = "\n" + r[s]), (i = o));
            }
            n[a] = r.join("");
          ...
          if (!e.settings || !1 !== e.settings["whitespace-normalization"])
            if ((e.element && e.element.parentNode) || !e.code) {
              var n = e.element.parentNode,
                a = /\bno-whitespace-normalization\b/;
              if (
                e.code &&
                n &&
                ...
                for (var r = n.childNodes, i = "", s = "", o = !1, l = 0; l < r.length; ++l) {
                  var u = r[l];
                  u == e.element
                    ? (o = !0)
                    : "#text" === u.nodeName && (o ? (s += u.nodeValue) : (i += u.nodeValue), n.removeChild(u), --l);
                }
                if (e.element.children.length && Prism.plugins.KeepMarkup) {
                  var c = i + e.element.innerHTML + s;
                  (e.element.innerHTML = t.normalize(c, e.settings)), (e.code = e.element.textContent);
                } else (e.code = i + e.code + s), (e.code = t.normalize(e.code, e.settings));
              }
      ...
      Prism.hooks.add("complete", function(e) {
        if (e.code) {
          ...
          if (
            ...
            0,
              n.test(e.element.className) && (e.element.className = e.element.className.replace(n, "")),
              n.test(t.className) || (t.className += " line-numbers");
            var a,
              r = e.code.match(/\n(?!$)/g),
              i = r ? r.length + 1 : 1,
              s = 1;
            t.hasAttribute("data-start") && (s = parseInt(t.getAttribute("data-start"), 10));
            for (var o, l = i + 1, u = "", c = s; c < l; c++)
              u += '<a href="#' + (o = "line-" + c) + '" name="' + o + '"></a>';
            ((a = document.createElement("span")).className = "line-numbers-rows"),
              (a.innerHTML = u),
              t.hasAttribute("data-start") && (t.style.counterReset = "linenumber " + (s - 1)),
  ...
  (function() {
    if ("undefined" != typeof self && self.Prism && self.document) {
      ...
      var e = (Prism.plugins.toolbar.registerButton = function(e, n) {
        ...
        n = (Prism.plugins.toolbar.hook = function(a) {
          var e = a.element.parentNode;
          if (e && /pre/i.test(e.nodeName) && !e.classList.contains("code-toolbar")) {
      ...
      if (Prism.plugins.toolbar) {
        ...
        if (!r) {
          ...
          (e.onload = function() {
            ...
            (e.src = "https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.1/clipboard.min.js"),
            t.appendChild(e);
        }
        Prism.plugins.toolbar.registerButton("copy-to-clipboard", function(t) {
          ...
          function e() {
            ...
            e.on("success", function() {
              (n.textContent = "Copied!"), a();
            }),
              e.on("error", function() {
                (n.textContent = "Press Ctrl+C to copy"), a();
              });
          }
          return (n.textContent = "Copy"), r ? e() : i.push(e), n;
        });
