...
var RHDatetime = (function(e) {
  function t() {
    ...
    return (
      ...
      e.shadowRoot.appendChild(datetimeTemplate.content.cloneNode(!0)),
      (e.type = e.getAttribute("type") || "local"),
      e
    );
  }
  return (
    _inherits(t, HTMLElement),
    _createClass(
      t,
      [
        {
