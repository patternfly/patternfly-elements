...
storiesOf("Layouts", module).add(
  "rhe-layouts",
  () => `
  <link rel="stylesheet" type="text/css" href="/rhe-layouts/rhe-base.css">
  <link rel="stylesheet" type="text/css" href="/rhe-layouts/rhe-layouts.css">
  <style>
  body {
    padding: 32px;
  }
