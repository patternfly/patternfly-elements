  ...
  _show() {
    ...
    switch (this.getAttribute('data-position')) {
      case 'left':
        ...
        this.style.left = `${left - tooltipBoundingClientRect.width - padding}px`;
        break;
      ...
      case 'top':
        this.style.top = `${top - tooltipBoundingClientRect.height - padding}px`;
        this.style.left = `${left + boundingClientRect.width / 2 - tooltipBoundingClientRect.width / 2}px`;
        break;
