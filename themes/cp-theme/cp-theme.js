...
*/
  var l,
    aa = "undefined" != typeof window && window === this ? this : "undefined" != typeof commonjsGlobal && null != commonjsGlobal ? commonjsGlobal : this,
    m = {};
  function n() {
  ...
  function da(a, b) {
    ...
    a.parent &&
      ...
      a.atRule
        ? 0 === c.indexOf("@media")
          ? (a.type = ha)
          : c.match(ia) && ((a.type = r), (a.keyframesName = a.selector.split(fa).pop()))
  ...
  function ua(a) {
    u =
      a && a.shimcssproperties
        ? !1
        : t || !(navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/) || !window.CSS || !CSS.supports || !CSS.supports("box-shadow", "0 0 0 var(--foo)"));
  }
  ...
  function J(a, b, c) {
    var e = I,
      d = a.__cssBuild;
    t || "shady" === d ? (b = z(b, c)) : ((a = F(a)), (b = Ga(e, b, a.is, a.s, c) + "\n\n"));
    return b.trim();
  }
      ...
      if (c.target !== document.documentElement && c.target !== document.head)
        for (var e = 0; e < c.addedNodes.length; e++) {
          ...
          if (d.nodeType === Node.ELEMENT_NODE) {
            ...
            h = g;
            g = h.indexOf(I.a);
            if ((h = -1 < g ? h[g + 1] : "") && f === d.ownerDocument) H(d, h, !0);
            else if (f.nodeType === Node.DOCUMENT_FRAGMENT_NODE && (f = f.host))
              if (((f = F(f).is), h === f)) for (d = window.ShadyDOM.nativeMethods.querySelectorAll.call(d, ":not(." + I.a + ")"), f = 0; f < d.length; f++) Ea(d[f], h);
  ...
  if (!t) {
    ...
    if (window.customElements && !window.customElements.polyfillWrapFlushCallback) bb(document);
    else {
      var cb = function() {
        bb(document.body);
      };
      ...
      (b =
        0 <= b.indexOf(";")
          ...
          : Ca(b, function(b, d, f, h) {
              if (!d) return b + h;
              (d = T(a, c[d], c)) && "initial" !== d ? "apply-shim-inherit" === d && (d = "inherit") : (d = T(a, c[f] || f, c) || f);
              return b + (d || "") + h;
            }));
    return (b && b.trim()) || "";
  }
  ...
  function kb(a, b) {
    ...
    A(
      ...
      function(a) {
        ...
        b && a.f.i && d && fb.call(b, d) && (S(a, c), (a = a.index), (d = parseInt(a / 32, 10)), (e[d] = (e[d] || 0) | (1 << a % 32)));
      },
      null,
      !0
    );
  ...
  function lb(a, b, c, e, d) {
    ...
    if (c.f.i) {
      ...
      "shady" === e && ((h = f === b + " > *." + b || -1 !== f.indexOf("html")), (g = !h && 0 === f.indexOf(b)));
      "shadow" === e && ((h = ":host > *" === f || "html" === f), (g = g && !h));
      if (h || g) (e = b), g && (c.g || (c.g = L(I, c, I.b, a ? Ha + a : "", b)), (e = c.g || b)), d({ L: e, J: g, R: h });
    }
  }
  function mb(a, b) {
    var c = {},
    ...
    return J(b, d, function(b) {
      ...
      if (!t && !Aa(b) && b.cssText) {
        ...
        if (b.B)
          if (null == b.v) {
            b.v = [];
            for (var q in g) (k = g[q]), (k = k(d)), d !== k && ((d = k), b.v.push(q));
          } else {
        ...
        q = b.g.split(",");
        k = 0;
        for (var ub = q.length, O; k < ub && (O = q[k]); k++) q[k] = O.match(h) ? O.replace(f, d) : d + " " + O;
        b.selector = q.join(",");
      }
    });
  }
  ...
  function qb(a, b) {
    ...
    a.textContent = z(e, function(a) {
      ...
      a.f && a.f.cssText && ((d = d.replace(ma, "").replace(na, "")), (a.cssText = jb(c, d, b)));
    });
  }
  ...
  l.prepareTemplate = function(a, b, c) {
    if (!a.l) {
      ...
      a.extends = c;
      m[b] = a;
      var e = (e = a.content.querySelector("style")) ? e.getAttribute("css-build") || "" : "";
      var d = [];
      for (var f = a.content.querySelectorAll("style"), h = 0; h < f.length; h++) {
        ...
        if (g.hasAttribute("shady-unscoped")) {
          if (!t) {
            var k = g.textContent;
            za.has(k) || (za.add(k), (k = g.cloneNode(!0)), document.head.appendChild(k));
      ...
      e = [];
      v || (e = ib(a._styleAst));
      if (!e.length || v) (d = t ? a.content : null), (b = rb[b]), (f = J(c, a._styleAst)), (b = f.length ? C(f, c.is, d, b) : void 0), (a.a = b);
      a.c = e;
    }
  };
  function tb(a) {
  ...
  function Y(a) {
    !a.a && window.ShadyCSS && window.ShadyCSS.ApplyShim && ((a.a = window.ShadyCSS.ApplyShim), (a.a.invalidCallback = ra));
    tb(a);
  }
  l.flushCustomStyles = function() {
    ...
    if (this.b) {
      ...
      if (this.b.enqueued) {
        ...
        else for (vb(this, this.c, this.l), b = 0; b < a.length; b++) (c = this.b.getStyleForCustomStyle(a[b])) && qb(c, this.l.m);
        this.b.enqueued = !1;
  ...
  l.styleElement = function(a, b) {
    ...
    if (v) {
      ...
      if (((k = m[c]) || a === this.c) && k && k.a && !sa(k)) {
        if (sa(k) || k._applyShimValidatingVersion !== k._applyShimNextVersion) Y(this), this.a && this.a.transformRules(k._styleAst, c), (k.a.textContent = J(a, e.j)), ta(k);
        t && (c = a.shadowRoot) && (c.querySelector("style").textContent = J(a, e.j));
        e.j = k._styleAst;
      }
      ...
      h = c.h;
      (g = b && b.h) || ((g = this.w[k] = (this.w[k] || 0) + 1), (g = k + "-" + g));
      c.h = g;
      g = c.h;
      d = U;
      ...
      f = Q(a);
      var x = f.a;
      x && !t && x !== e && (x._useCount--, 0 >= x._useCount && x.parentNode && x.parentNode.removeChild(x));
      t
        ? f.a
          ? ((f.a.textContent = d), (e = f.a))
          : d && (e = C(d, g, a.shadowRoot, f.b))
        : e
          ? e.parentNode || (gb && -1 < d.indexOf("@media") && (e.textContent = d), Ba(e, null, f.b))
          : d && (e = C(d, g, null, f.b));
      e && ((e._useCount = e._useCount || 0), f.a != e && e._useCount++, (f.a = e));
      g = e;
      t ||
        ((e = c.h),
        (f = d = a.getAttribute("class") || ""),
        h && (f = d.replace(new RegExp("\\s*x-scope\\s*" + h + "\\s*", "g"), " ")),
        (f += (f ? " " : "") + "x-scope " + e),
        d !== f && E(a, f));
      b || ((a = W.cache[k] || []), a.push({ i: c.m, styleElement: g, h: c.h }), a.length > W.a && a.shift(), (W.cache[k] = a));
    }
  };
  function wb(a, b) {
  ...
  var Z = new X(),
    xb,
    yb;
  window.ShadyCSS && ((xb = window.ShadyCSS.ApplyShim), (yb = window.ShadyCSS.CustomStyleInterface));
  window.ShadyCSS = {
    ScopingShim: Z,
...
*/
  ...
  function t(a, c) {
    ...
    a.parent &&
      ((b = c.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1)),
      (b = ba(b)),
      (b = b.replace(u, " ")),
      ...
      a.atRule
        ? 0 === b.indexOf("@media")
          ? (a.type = v)
          : b.match(ca) && ((a.type = x), (a.keyframesName = a.selector.split(u).pop()))
  ...
  function F(a) {
    D =
      a && a.shimcssproperties
        ? !1
        : C || !(navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/) || !window.CSS || !CSS.supports || !CSS.supports("box-shadow", "0 0 0 var(--foo)"));
  }
  window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss
    ...
    for (var b, d, e = {}, f = 0, h; f < c.length; f++)
      if ((b = c[f]))
        if (((h = b.split(":")), 1 < h.length)) {
          ...
          m &&
            (m[1]
              ? (g.b || ((g.b = document.createElement("meta")), g.b.setAttribute("apply-shim-measure", ""), (g.b.style.all = "initial"), document.head.appendChild(g.b)),
  ...
  V.prototype.styleSubtree = function(a, c) {
    ...
    if (a.shadowRoot) for (this.styleElement(a), a = a.shadowRoot.children || a.shadowRoot.childNodes, c = 0; c < a.length; c++) this.styleSubtree(a[c]);
    else for (a = a.children || a.childNodes, c = 0; c < a.length; c++) this.styleSubtree(a[c]);
  };
